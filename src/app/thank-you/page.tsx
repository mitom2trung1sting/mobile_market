          ...
          <div className="lg:col-start-2">
            ...
            {order._isPaid ? (
              <p className="mt-2 text-base text-muted-foreground">
                Đơn hàng của bạn đã được xử lý. Chúng tôi đã gửi thông tin chi
                tiết về đơn hàng của bạn đến{" "}
              ...
              <p className="mt-2 text-base text-muted-foreground">
                Chúng tôi đang đánh giá đơn hàng của bạn và hiện đang xử lý nó.
                Vui lòng kiên nhẫn, chúng tôi sẽ gửi đơn hàng đến cho bạn sớm
                nhất có thể!
              </p>
            )}
                    ...
                    <li key={product.id} className="flex space-x-6 py-6">
                      ...
                      <div className="flex-auto flex flex-col justify-between">
                        <div className="space-y-1">
                          ...
                          <p className="my-1">Danh mục: {label}</p>
                        </div>
