        ...
        <Container style={container}>
          ...
          <Section style={informationTable}>
            <Row style={informationTableRow}>
              ...
              <Column style={informationTableColumn}>
                <Text style={informationTableLabel}>Ngày lập hóa đơn</Text>
              ...
              <Column style={informationTableColumn}>
                <Text style={informationTableLabel}>Mã đơn hàng</Text>
                <Link
                  style={{
                    ...informationTableValue,
                  }}
          ...
          <Section style={productTitleTable}>
            <Text style={productsTitle}>Tóm tắt về đơn hàng</Text>
          </Section>
          ...
          <Section>
            ...
            >
              <Text style={productTitle}>Phí giao dịch</Text>
            </Column>
          ...
          <Section align="right">
            <Column style={tableCell} align="right">
              <Text style={productPriceTotal}>Thành tiền</Text>
            </Column>
          ...
          <Text style={footerLinksWrapper}>
            <Link href="#">Cài đặt tài khoản</Link> •{" "}
